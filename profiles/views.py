...
def stat_gen(request):
    ...
    return render(request, 'stat_gen.html',
                  {'customer': cur_customer, 'accounts': accounts, 'transaction': all_transactions, 'msg': msg})
...
def show_ecs_options(request):
    return render(request, "ecs.html")
...
def start_ecs(request):
    msg = ""
    return render(request, 'set_up_ecs.html', {"msg": msg})
...
def show_due_bills(request):
    ...
    print(bills_list)
    return render(request, 'ecs_show_bills.html', {'bills_list': bills_list});
